...
function UserProfile() {
  ...
  const updateProfile = async (e) => {
    ...
    const response = await axios.post(`http://localhost:8000/api/user-update-form/${user_id}/`, formData, {
      headers: {
        'Content-Type': 'multipart/form-data',
      },
    });

    getUser(); // Call the getUser function after updating the image
  };
    ...
    <div className='sub-section'>
      <div className='sub-one'>
        ...
        <form onSubmit={updateProfile} encType='multipart/form-data'>
          <input type='file' name='profile_img' onChange={(e) => setImage(e.target.files[0])} />
